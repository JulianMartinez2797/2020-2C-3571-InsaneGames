...
namespace TGC.MonoGame.InsaneGames.Maps
{
    class MapRepo
    {
        ...
        static public Map Level1(TGCGame game, GraphicsDevice graphicsDevice)
        {
            ...
            builder.AddBox(0, 0, leftFront).AddBox(0, 1, frontBack).AddBox(0, 2, frontBack).AddBox(0, 3, frontRightBack).AddBox(0, 4, leftFront, false).AddBox(0, 5, front).AddBox(0, 6, frontRight).AddBox(0, 7, leftFrontBack).AddBox(0, 8, frontBack).AddBox(0, 9, frontRight);
            builder.AddBox(1, 0, leftBack).AddBox(1, 1, front).AddBox(1, 2, frontBack).AddBox(1, 3, frontBack).AddBox(1, 4, rightBack).AddBox(1, 5, leftRight).AddBox(1, 6, leftBack).AddBox(1, 7, front).AddBox(1, 8, frontRightBack).AddBox(1, 9, leftRight);
            ...
            builder.AddBox(9, 0, leftBack).AddBox(9, 1, frontBack).AddBox(9, 2, back).AddBox(9, 3, rightBack).AddBox(9, 4, leftRightBack).AddBox(9, 5, leftFrontBack, false).AddBox(9, 6, frontBack).AddBox(9, 7, rightBack).AddBox(9, 8, leftFrontBack).AddBox(9, 9, rightBack);
            ...
            // TODO: Ver porque se rompen las vidas al usarlas con Effect de collectible
            ...
            //builder.AddCollectible(new Life(Matrix.CreateTranslation(1370f, 5, 100), 2f, 100));
            //builder.AddCollectible(new Armor(Matrix.CreateTranslation(1325, 5, 125), 1.75f, 100));
